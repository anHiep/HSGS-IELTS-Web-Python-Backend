...
let STScoreAPIKey = process.env.STS_CORE_API_KEY;
let apiMainPathSample = '';
let apiMainPathSTS = '';
...
export const updateRecordingState = async () => {
    if (isRecording) {
        stopRecording();
        return
    }
...
export const changeLanguage = (language, generateNewSample = false) => {
...
export const playRecording = async (start = null, end = null) => {
    blockUI();
